...
class DailyDhikrScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const packages = DhikrData.dailyDhikrPackage;
    ...
    return Container(
      ...
      child: ListTile(
        ...
        trailing: Icon(
            ...
            color: isDark ? const Color(0xFF3E4450) : Colors.grey[400],
            size: 14
        ),
        onTap: () {
          Navigator.push(
...
class DhikrListDetailScreen extends StatelessWidget {
  ...
  Widget _buildDhikrItem(BuildContext context, Map<String, dynamic> dhikr, bool isDark) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: isDark ? [] : [BoxShadow(color: Colors.black.withValues(alpha:0.02), blurRadius: 5)],
      ),
      child: Column(
          ...
          Row(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => DigitalTasbih(
  ...
  void _startFullSequence(BuildContext context) {
    List<Dhikr> list = dhikrs.map((d) => Dhikr(
      d['title'],
      int.parse(d['target']),
      arabic: d['arabic'],
      meaning: d['meaning'],
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) => DigitalTasbih(packageName: packageName, dhikrs: list)));
  }
}
